...
contract TestBridgeMessage {
    ...
    // function testMessageType(bytes29 _view) external pure returns (Types) {
    ...
    // function testIsRequestDetails(bytes29 _action) external pure returns (bool) {
    //     // return
    ...
    // function testTryAsTransfer(bytes29 _action) external pure returns (bytes29) {
    ...
    // function testTryAsTokenId(bytes29 _tokenId) external pure returns (bytes29) {
    ...
    // function testTryAsMessage(bytes29 _message) external pure returns (bytes29) {
